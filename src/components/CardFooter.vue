<template>
    <div>
        ...
        <div class="text-center">
            <a href="https://www.facebook.com/profile.php?id=100004062664969" target="_blank"
            ...
            <a href="https://www.instagram.com/_shahislam/" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"><font-awesome-icon
                    icon="fa-brands fa-instagram" /></a>
            <a href="https://github.com/sh9hislam" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
                    icon="fa-brands fa-github" /></a>
            <a href="https://t.me/sh9hislam"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
